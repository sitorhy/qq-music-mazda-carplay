...
public class SongService {
    ...
    public String getAlbumSongs(long dissId) throws IOException {
        return requestHeadersSession.get("http://c.y.qq.com/qzone/fcg-bin/fcg_ucc_getcdinfo_byids_cp.fcg", new LinkedHashMap<String, Object>() {
                    {
                        put("type", 1);
                        put("utf8", 1);
                        put("loginUin", 0);
    ...
    public String getSongSource(String songMid, String strMediaMid, SongTypeEnum type) throws IOException {
        String typeName;
        switch (type) {
            case MP3 : {
                typeName = "320";
    ...
    public String getSingerTopSongs(String singerMid, long pageNo, long pageSize) throws IOException {
